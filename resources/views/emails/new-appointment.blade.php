                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border: 1px solid rgba(201,168,76,0.3); border-radius: 16px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 30px 30px 10px; text-align: center;">
                            <div style="background: rgba(201,168,76,0.1); border: 1px solid rgba(201,168,76,0.3); border-radius: 50px; display: inline-block; padding: 8px 24px;">
                                <span style="color: #c9a84c; font-size: 14px; font-weight: 600;">📋 NEW APPOINTMENT BOOKING</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 30px 10px;">
                            <p style="color: #f5f0e8; font-size: 16px; margin: 0; line-height: 1.6;">
                                A new appointment has been booked. Please review and approve or cancel it from the admin dashboard.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: rgba(201,168,76,0.05); border: 1px solid rgba(201,168,76,0.2); border-radius: 12px; overflow: hidden;">
                                <tr>
                                    <td style="padding: 20px 24px; border-bottom: 1px solid rgba(201,168,76,0.1);">
                                        <p style="color: #888; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 5px;">👤 Customer</p>
                                        <p style="color: #f5f0e8; font-size: 16px; font-weight: 600; margin: 0;">
                                ...
                                <tr>
                                    <td style="padding: 15px 24px; border-bottom: 1px solid rgba(201,168,76,0.1);">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="50%">
                                                    <p style="color: #888; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 5px;">📧 Email</p>
                                                    <p style="color: #f5f0e8; font-size: 14px; margin: 0;">
                                                        {{ $appointment->email }}
                                                    </p>
                                                </td>
                                                <td width="50%">
                                                    <p style="color: #888; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 5px;">📱 Phone</p>
                                                    <p style="color: #f5f0e8; font-size: 14px; margin: 0;">
                                                        {{ $appointment->phone }}
                                                    </p>
                                                </td>
                                ...
                                <tr>
                                    <td style="padding: 15px 24px; border-bottom: 1px solid rgba(201,168,76,0.1);">
                                        <p style="color: #888; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 5px;">✂️ Service</p>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px; text-align: center;">
                            <p style="color: #b0a890; font-size: 14px; margin: 0 0 15px;">
                                Log in to the admin dashboard to approve or cancel this booking.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background: #111; padding: 20px 30px; text-align: center; border-top: 1px solid rgba(201,168,76,0.15);">
                            <p style="color: #666; font-size: 12px; margin: 0;">
                                Mystic Mirror Salon — Admin Notification ✨
                            </p>
