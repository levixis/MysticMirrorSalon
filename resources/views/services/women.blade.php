@extends('layouts.app')
@section('title', "Women's Packages - Mystic Mirror Salon")
...
<section class="page-header">
    <div class="container">
        <h1><i class="fas fa-female" style="margin-right: 0.5rem;"></i> Packages for Ladies</h1>
        <p>Luxurious beauty & hair care treatments designed for you</p>
    </div>
</section>
